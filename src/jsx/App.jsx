...
function App() {
  ...
  const fetchExternalData = () => {
    ...
    const data_file = 'data.json?v=february';
    let values;
    try {
      values = Promise.all([
